...
parser.add_argument('-num_epochs', help='number of epochs', default=60, type=int)
parser.add_argument('-category', help='output image path', default='v33', type=str)
parser.add_argument('-weight_out', help='output weight path', default='v33', type=str)
...
conditionnet_mix_optimizer1 = torch.optim.Adam(net.ADS.parameters(), lr=learning_rate2)
...
conditionnet_mix_optimizer2 = torch.optim.Adam(net.TDS.parameters(), lr=learning_rate3)
# conditionnet_mix_scheduler = torch.optim.lr_scheduler.MultiStepLR(conditionnet_mix_optimizer)
