...
condition feature----------------
    ...
    def __init__(self, nf=64, residual_lr=1, kernel_size=3):
...
class PMS(nn.Module):
    def __init__(self, in_ch=3, out_ch=3):
        ...
        self.res1 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res2 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res3 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res4 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res5 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res6 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res7 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res8 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
        self.res9 = ResBlock(nf=64, residual_lr=1, kernel_size=3)
...
class PMS_1(nn.Module):
    def __init__(self, scale=4, input_channels=3, channels=64, n_block=10, n_conv_each_block=2,
                 residual_lr=1, kernel_size=3, conv_index='22'):
        ...
        for _ in range(n_block):
            layers.append(ResBlock(nf=channels, residual_lr=residual_lr,
...
class GUPDM(nn.Module):
    def __init__(self, args=None):
        ...
        self.n_block1 = self.args.n_block1
        self.n_block2 = self.args.n_block2
        ...
        self.PMS = PMS_1(scale=self.scale,
                                  ...
                                  n_conv_each_block=self.n_conv_each_block, residual_lr=self.residual_lr,
    ...
    def reset_batch_size(self, batch_size=8):
...
if __name__ == "__main__":
    ...
    # net.reset_batch_size(batch_size=1)
